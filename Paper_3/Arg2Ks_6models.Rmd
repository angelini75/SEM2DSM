...
plot(xyplot(predicted ~ observed| hor, res[res$sp=="CEC",], 
            ...
            panel = function(x, y) {
         panel.xyplot(x, y, pch = ".", cex = 2.5, col="#555555")
...
plot(xyplot(predicted ~ observed| sp, res[res$sp=="CEC",], groups = hor, pch = ".", cex = 2.5,
            aspect= 1 , layout = c(1,1), 
            scales = list(limits = c(0,45))),
     position=c(0,0,0.35,1))
plot(xyplot(predicted ~ observed| sp, res[res$sp=="OC",], groups = hor, pch = ".", cex = 2.5,
            aspect= 1 , layout = c(1,1), 
            scales = list(limits = c(0,4))),
     position=c(0.35,0,0.695,1), newpage = FALSE)
plot(xyplot(predicted ~ observed| sp, res[res$sp=="clay",], groups = hor, pch = ".", cex = 2.5,
            aspect= 1 , layout = c(1,1), 
            scales = list(limits = c(0,70))),
