...
Results
```{r, echo=F }
knitr::kable(report, caption = "Model 1", digits = 3)
knitr::kable(report2, caption = "Model 1", digits = 3)
```
...
Results
```{r, echo=F }
knitr::kable(report, caption = "Model 4", digits = 3)
knitr::kable(report2, caption = "Model 4", digits = 3)
```
