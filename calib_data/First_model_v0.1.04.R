...
fit2 <- lavaan(model = third_model, data = d,
               ...
               int.ov.free = T, int.lv.free = FALSE, fixed.x = "default", #intercepts are estimated instead 0
               ...
               auto.cov.y = F, auto.th = F, auto.delta = T, # ?? auto.th if T they are free, otherwise calculated from data ??
